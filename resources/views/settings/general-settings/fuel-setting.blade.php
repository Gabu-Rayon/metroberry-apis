                                        ...
                                        <div class="card mb-4 p-5">
                                            <form action="admin/setting" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div>
                                                    <fieldset>
                                                        ...
                                                        <div class="d-flex justify-content-between">
                                                            <div class="panel-heading my-2">
                                                                <code
                                                                    class="badge badge-pill badge-info text-light setting_key">setting('fuel.station_code_prefix')</code>
                                                                <a href="javascript:void(0);"
                                                                    class="panel-action-btn clipboard"
                                                                    data-clipboard-text="setting('fuel.station_code_prefix')">
                                                        ...
                                                        <div class="panel-body mt-1 mb-3">
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <input id="fuel.station_code_prefix"
                                                                        class="form-control" type="text"
                                                                        placeholder="Setting Station Code Prefix"
                                                                        name="data[8]" id="data[8]" value="FSC-" />
                                                                    <div class="my-1">
                                                    ...
                                                    <fieldset>
                                                        <legend>Requisition Code Prefix</legend>
                                                        <div class="d-flex justify-content-between">
                                                            <div class="panel-heading my-2">
                                                                <code
                                                                    class="badge badge-pill badge-info text-light setting_key">setting('fuel.requisition_code_prefix')</code>
                                                                <a href="javascript:void(0);"
                                                                    class="panel-action-btn clipboard"
                                                                    data-clipboard-text="setting('fuel.requisition_code_prefix')">
                                                                    <svg width="18px" version="1.1"
                                                                        xmlns="http://www.w3.org/2000/svg"
                                                                        xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
                                                                        y="0px" viewBox="0 0 1000 1000"
                                                            ...
                                                            <div class="panel-actions">
                                                                <a href="admin/setting/12/move-down"
                                                                    class="panel-action-btn" title="Move Down">
                                                                    <img
                                                                        src="../../../nanopkg-assets/image/setting/arrow-down.svg?v=1">

                                                                </a>
                                                                <a href="admin/setting/12/move-up"
                                                        ...
                                                        <div class="panel-body mt-1 mb-3">
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <input id="fuel.requisition_code_prefix"
                                                                        class="form-control" type="text"
                                                                        placeholder="Setting Requisition Code Prefix"
                                                                        name="data[12]" id="data[12]" value="FRSC-" />
                                                                    <div class="my-1">
