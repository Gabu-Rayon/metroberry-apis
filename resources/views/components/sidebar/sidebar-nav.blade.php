    ...
    <ul class="metismenu text-capitalize">
        ...
        @if (\Auth::user()->can('view report purchase'))
            @include('components.sidebar.sidebar-dropdown', [
                'title' => 'Reports',
                'icon' => '<svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                                                                                                                                                                                                                            <path d="M15.1114 23.4167V23.1802H3.77808C2.6049 23.1785 1.65485 22.2284 1.65308 21.0552V7.36139H1.41667C0.634849 7.36316 0.002652 7.99624 0 8.77806V23.4167C0.00265631 24.1985 0.634849 24.8307 1.41667 24.8333H13.6948C14.4757 24.8307 15.1088 24.1985 15.1114 23.4167Z" fill="#6C6C6C" />
                                                                                                                                                                                                                                                                            <path d="M14.8134 5.50998C14.6425 5.30811 14.4185 5.15935 14.167 5.0788V8.30517H16.9534C16.9029 8.09799 16.8073 7.90497 16.6718 7.74027L14.8134 5.50998Z" fill="#6C6C6C" />
