        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group row my-2">
                    ...
                    <div class="col-sm-7">
                        <input name="start_location" required class="form-control" type="text" placeholder="Start Location" id="start_location" value="{{ $route->start_location->name ?? '' }}" />
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                ...
                <div class="form-group row my-2">
                    ...
                    <div class="col-sm-7">
                        <input name="end_location" required class="form-control" type="text" placeholder="End Location" id="end_location" value="{{ $route->end_location->name ?? '' }}" />
                    </div>
                </div>
            </div>
        </div>
