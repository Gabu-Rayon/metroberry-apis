<form action="{{ route('metro.berry.account.setting.destroy', $setting->id) }}" method="POST" class="needs-validation modal-content" novalidate="novalidate" enctype="multipart/form-data">
    @csrf
    @method('DELETE')
