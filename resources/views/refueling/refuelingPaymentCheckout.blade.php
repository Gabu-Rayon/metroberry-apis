                            ...
                            <div class="card mb-4">
                                <div class="card-header">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            <h6 class="fs-17 fw-semi-bold mb-0">Trip Route : {{ $refueling->route->name }}
                                            </h6>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="actions">
                                            <div class="accordion-header d-flex justify-content-end align-items-center"
                                                ...
                                                @if (\Auth::user()->can('resend trip invoice'))
                                                    <a href="{{ route('billed.refueling.resend.invoice', ['id' => $refueling->id]) }}"
                                                ...
                                                @if (in_array($trip->status, ['billed', 'partially paid']))
                                                    @if (Auth::user()->role == 'organisation')
                                                        <a class="btn btn-primary btn-sm" href="javascript:void(0);"
                                                           onclick="axiosModal('{{ route('billed.refueling.receive.payment', ['id' => $refueling->id]) }}')">
                                                ...
                                                @if (in_array($trip->status, ['billed', 'partially paid', 'paid']))
                                                    @if (\Auth::user()->can('download refueling invoice'))
                                                        <a href="{{ route('refueling.download.invoice', ['id' => $refueling->id]) }}"
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-lg-6">
                                            ...
                                            <div class="form-group row my-2">
                                                ...
                                                <div class="col-sm-7">
                                                    {{ $refueling->vehicle->model }}
                                                </div>
                                            </div>
                                            <div class="form-group row my-2">
                                                <label for="fuel_type" class="col-sm-5 col-form-label">Plate Number
                                                    <i class="text-danger">:</i></label>
                                                <div class="col-sm-7">
                                                    {{ $refueling->vehicle->plate_number }}
                                                </div>
                                            </div>
                                            <div class="form-group row my-2">
                                                <label for="engine_size" class="col-sm-5 col-form-label">Vehicle Engine Size
                                                    <i class="text-danger">:</i></label>
                                                <div class="col-sm-7">
                                                    {{ $refueling->vehicle->engine_size }} cc
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12 col-lg-6">
                                            <p class="mb-0 mr-3 text-dark fw-bold">Station :</p>
                                            <div class="form-group row my-2">
                                                <label for="plate_number" class="col-sm-5 col-form-label"> Name : <i
                                                        class="text-danger">:</i></label>
                                                <div class="col-sm-7">
                                                    {{ $refueling->station->user->name }}
                                                </div>
                                            </div>
                                            <div class="form-group row my-2">
                                                <label for="plate_number" class="col-sm-5 col-form-label"> Address <i
                                                        class="text-danger">:</i></label>
                                                <div class="col-sm-7">
                                                    {{ $refueling->station->user->address }}
                                                </div>
                                            </div>
                                            <div class="form-group row my-2">
                                                <label for="fuel_type" class="col-sm-5 col-form-label">Phone
                                                    <i class="text-danger">:</i></label>
                                                <div class="col-sm-7">
                                                    {{ $refueling->station->user->phone }}
                                                </div>
                                            </div>
                                            <div class="form-group row my-2">
                                                <label for="engine_size" class="col-sm-5 col-form-label">Station Code
                                                    Contact
                                                    <i class="text-danger">:</i></label>
                                                <div class="col-sm-7">
                                                    {{ $refueling->station->station_code }}
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12 col-lg-6">
                                            <p class="mb-0 mr-3 text-dark fw-bold">Payment Period :</p>
                                            <div class="form-group row my-2">
                                                <label for="color" class="col-sm-5 col-form-label">Period <i
                                                        class="text-danger">:</i></label>
                                                <div class="col-sm-7">
                                                    {{ $refueling->station->payment_period }}
                                                </div>
                                            </div>
                                            <div class="form-group row my-2">
                                                <label for="color" class="col-sm-5 col-form-label">Station Status <i
                                                        class="text-danger">:</i></label>
                                                <div class="col-sm-7">
                                                    <p class="mb-0 mr-3 text-dark fw-bold">Status :</p>
                                                    @if ($refueling->station->status == 'active')
                                    ...
                                    <div class="col-md-12 col-lg-12">
                                        <table class="table" id="checkout-table">
                                            ...
                                            <tr>
                                                ...
                                                <th title="Station">Refueling Station</th>
                                                <th title="Refueling station Payment Period">Refueling(station) Payment Period</th>
                                                <th title="Refueling Cost ">Charges :</th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                            @php $item = 1 @endphp
                                            <tr>
                                                <td>{{ $item++ }}</td>
                                                <td> {{ $refueling->vehicle->model }} <br>
                                                    {{ $refueling->vehicle->plate_number }}
                                                </td>
                                                <td> {{ $refueling->station->user->name }}</td>
                                                <td> {{ $refueling->station->payment_period }}</td>
                                                <td>Kes. {{ $refueling->refuelling_cost }}</td>
                                            </tr>
                                            <tr>
                                                <td colspan="3" class="text-right my-20"><strong>Total</strong>
                                                </td>
                                                <td><strong>Kes.{{ $refueling->refuelling_cost }}</strong></td>
                                            </tr>
                                            <tr>
