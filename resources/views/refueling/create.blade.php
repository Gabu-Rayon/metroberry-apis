<form action="{{ route('refueling.create') }}" method="POST" class="needs-validation modal-content" novalidate="novalidate" enctype="multipart/form-data">
  @csrf
  ...
  <div class="modal-body">
    ...
    <div class="form-group row my-2">
      ...
      <div class="col-sm-7">
          <input name="attendant_phone" class="form-control" type="text" id="attendant_phone" required />
      </div>
    </div>
