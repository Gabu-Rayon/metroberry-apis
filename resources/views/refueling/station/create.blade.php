<form action="admin/refueling/station" method="POST" class="needs-validation modal-content" novalidate="novalidate"
    enctype="multipart/form-data" onsubmit="submitFormAxios(event)">
    @csrf
    <div class="card-header my-3 p-2 border-bottom">
        <h4>Fuel Station Create</h4>
    </div>
        ...
        <div class="row">
            <div class="col-md-6 my-1">
                ...
                <select name="vendor_id" id="vendor_id" class="form-control select2-ajax"
                    data-ajax-url="admin/refueling/station/vendor-list" data-placeholder="Select vendor"
                    required></select>
