...
<body class="fixed sidebar-mini">
           ...
           @include('components.sidebar.sidebar')
            ...
            @include('components.navbar')
                    ...
                    <div class="body-content">
                        ...
                        <div id="page-axios-data" data-table-id="#driver-table" data-create="admin/permission" data-edit="admin/permission/edit" data-update="admin/permission"
    ...
    <!-- END layout-wrapper -->
            ...
            <!-- Modal -->
<div class="modal fade" id="create-permission-modal"
