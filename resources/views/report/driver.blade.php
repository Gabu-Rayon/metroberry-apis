                                                    ...
                                                    <tbody>
                                                        @foreach ($drivers as $driver)
                                                            <tr>
                                                                ...
                                                                <td class="{{ $driver->vehicle ? '' : 'text-center' }}">{{ $driver->vehicle ? $driver->vehicle->plate_number : '-' }}</td>
                                                                <td class="{{ $driver->vehicle ? '' : 'text-center' }}">{{ $driver->vehicle ? $driver->vehicle->trips->count() : '-' }}</td>
                                                                <td class="{{ $driver->vehicle ? '' : 'text-center' }}">{{ $driver->vehicle ? $driver->vehicle->trips->where('status', 'cancelled')->count() : '-' }}</td>
                                                                <td class="{{ $driver->vehicle ? '' : 'text-center' }}">{{ $driver->vehicle? $driver->vehicle->trips->where('status', 'billed')->count() : '-' }}</td>
                                                                <td class="{{ $driver->vehicle ? '' : 'text-center' }}">{{ $driver->vehicle? $driver->vehicle->trips->where('status', 'billed')->sum('total_price') : '-' }}</td>
                                                            </tr>
                                                        @endforeach
                                                    </tbody>
                                                </table>
