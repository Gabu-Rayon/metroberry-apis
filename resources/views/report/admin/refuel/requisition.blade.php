...
@section('title', 'Refueling Requisition Report List')
@section('content')
                                ...
                                <div class="card mb-4">
                                    <div class="card-header">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                <h6 class="fs-17 fw-semi-bold mb-0">Fuel requisition report</h6>
                                            </div>
                                            <div class="text-end">
                                                <div class="actions">
                                                        ...
                                                        <div id="flush-collapseOne"
                                                            ...
                                                            <div class='row pb-3 my-filter-form'>
                                                                ...
                                                                <div class="col-sm-12 col-xl-4">
                                                                    ...
                                                                    <div class="form-group row mb-1">
                                                                        <label for="fuel_type"
                                                                            class="col-sm-5 col-form-label justify-content-start text-left">Fuel
                                                                            type </label>
                                                                        <div class="col-sm-7">
                                                                            <select class="form-control basic-single"
                                                                                name="fuel_type_id" id="fuel_type"
                                                                                tabindex="-1" aria-hidden="true">
                                                                                <option value="">Please select one
                                                                                </option>
                                                ...
                                                <table class="table" id="driver-table">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th title="Current odometer">Current odometer</th>
