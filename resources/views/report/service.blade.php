                                                        ...
                                                        <table class="table" id="driver-table">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="{{ $service->service_cost ? '' : 'text-center' }}">{{ $service->service_cost ?? '-' }}</td>
                                                                </tr>
                                                                @endforeach
                                                                <tr>
                                                                    <td colspan="3" class="text-center font-bold"><strong>Total Expenses</strong></td>
                                                                    @php
                                                                        $totalExpense = 0;
                                                                        foreach ($services as $service) {
                                                                    ...
                                                                    @endphp
                                                                    <td class="text-center font-bold"><strong>{{ $totalExpense }}</strong></td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                    </div>
