      ...
      <div class="row">
          <div class="col-md-12 col-lg-6">
              ...
              <div class="form-group row my-2">
                  ...
                  <div class="col-sm-7">
                      <input name="name" required class="form-control" type="text" placeholder="Name" id="name" value="{{ $customer->user->name }}" />
                  </div>
              </div>
              ...
              <div class="form-group row my-2">
                  ...
                  <div class="col-sm-7">
                      <input name="phone" required class="form-control" type="text" placeholder="Phone" id="phone" value="{{ $customer->user->phone }}" />
                  </div>
              </div>
                  ...
                  <div class="col-sm-7">
                      ...
                      >
                          ...
                          @foreach ($organisations as $organisation)
                              <option value="{{ $organisation->organisation_code }}" {{ $customer->customer_organisation_code == $organisation->organisation_code ? 'selected' : '' }}>
          ...
          <div class="col-md-12 col-lg-6">
              ...
              <div class="form-group row my-2">
                  ...
                  <div class="col-sm-7">
                      <input name="email" required class="form-control" type="email" placeholder="Email" id="email" value="{{ $customer->user->email }}" />
                  </div>
              </div>
