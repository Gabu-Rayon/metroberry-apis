<form action="/vehicle/insurance/company/{{ $company->id }}/deactivateStore" method="POST" class="needs-validation modal-content" novalidate="novalidate" enctype="multipart/form-data">
    @csrf
    @method('PUT')
