<form
    action="admin/vehicle/insurance"
    ...
    <div class="modal-body">
        <div class="row">
            <div class="col-md-12 col-lg-6">
                ...
                <div class="form-group row my-2">
                    <label for="policy_no" class="col-sm-5 col-form-label">Policy number <i
                            class="text-danger">*</i> </label>
                    <div class="col-sm-7">
            ...
            <div class="col-md-12 col-lg-6">
                ...
                <div class="form-group row mb-1">
                    <label for="vehicle" class="col-sm-5 col-form-label">Vehicle <i
                            class="text-danger">*</i> </label>
                    <div class="col-sm-7">
                ...
                <div class="form-group row my-2">
                    ...
                    <div class="col-sm-7">
                        <input name="deductible" required class="form-control" type="number" step="any"
                            placeholder="Deductible" id="deductible"
                            value="" required>
                    </div>
                </div>
