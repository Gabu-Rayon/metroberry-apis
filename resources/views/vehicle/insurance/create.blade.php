<form action="admin/vehicle/insurance" method="POST" class="needs-validation modal-content" novalidate="novalidate"
    ...
    <div class="modal-body">
        <div class="row">
            <div class="col-md-12 col-lg-6">
                    ...
                    <div class="col-sm-7">
                        <select class="form-control basic-single" name="company_id" id="company_id" tabindex="-1"
                            ...
                            <option value="13">
                                BMW</option>
                            <option value="16">
                                UNITED INSURANCE</option>
                        </select>
                    </div>
                </div>

                <div class="form-group row my-2">
                    <label for="policy_no" class="col-sm-5 col-form-label">Policy number <i class="text-danger">*</i>
                    </label>
                    <div class="col-sm-7">
                        <input name="policy_number" class="form-control" type="text" placeholder="Policy number"
                            id="policy_no" value="" required>
                    </div>
                </div>
                ...
                <div class="form-group row my-2">
                    <label for="recurring_period" class="col-sm-5 col-form-label">Recurring period <i
                            class="text-danger">*</i></label>
                    <div class="col-sm-7">
            ...
            <div class="col-md-12 col-lg-6">
                ...
                <div class="form-group row my-2">
                    ...
                    <div class="col-sm-7">
                        <input name="charge_payable" class="form-control" type="number"
                            step="any
                            placeholder="Charge payable" id="charge_payable"
                            value="" required>
                    </div>
                </div>
                ...
                <div class="form-group row my-2">
                    <label for="policy_document" class="col-sm-5 col-form-label">Policy document
