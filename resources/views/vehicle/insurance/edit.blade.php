<form action="{{ route('vehicle.insurance.update', $vehicleInsurance->id) }}"
    method="POST"class="needs-validation modal-content" novalidate enctype="multipart/form-data">
    @csrf
    @method('PUT')
    <div class="card-header my-3 p-2 border-bottom">
        <h4>Edit Vehicle Insurance Details</h4>
    </div>
        ...
        <div class="row">
            <div class="col-md-12 col-lg-6">
                ...
                <div class="form-group row my-2">
                    ...
                    <div class="col-sm-7">
                        <textarea class="form-control" name="remark" id="remarks" cols="30" rows="3">
                            {{ $vehicleInsurance->remark }}
                        </textarea>
                    </div>
                </div>
            </div>
            <div class="col-md-12 col-lg-6">
                ...
                <div class="form-group row my-2">
                    ...
                    <div class="col-sm-7">
                        <input type="file" accept="image/*" name="policy_document" id="policy_document" required
