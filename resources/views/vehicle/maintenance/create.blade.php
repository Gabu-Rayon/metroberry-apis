...
@section('title', 'Create Vehicle maintenance List')
@section('content')
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-2">
                                                        ...
                                                        <select name="employee_id" id="employee_id" class="form-control"
                                                            data-ajax-url="https://vms.bdtask-demoserver.com/admin/vehicle/maintenance/get-employee"
                                                            required>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="col-md-2">
                                                        ...
                                                        <select name="vehicle_id" id="vehicle_id" class="form-control"
                                                            data-ajax-url="https://vms.bdtask-demoserver.com/admin/vehicle/maintenance/get-vehicle"
                                                            required>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="col-md-2">
                                                        ...
                                                        <select name="maintenance_type_id" id="maintenance_type_id"
                                                            class="form-control"
                                                            data-ajax-url="https://vms.bdtask-demoserver.com/admin/vehicle/maintenance/get-maintenance-type"
                                                            required>
                                                        </select>
                                                    </div>
                                                    <div class="col-md-2">
                                                        ...
                                                        <input type="date" class="form-control" id="date"
                                                            name="date" placeholder="Date" value="2024-07-12" required>
                                                    </div>
