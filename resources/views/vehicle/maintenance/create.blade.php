...
<link href="../../admin-assets/css/logout.css?v=1" rel="stylesheet">
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form
            action="admin/vehicle/maintenance"
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        ...
                        <select name="employee_id" id="employee_id" class="form-control"
                            data-ajax-url="admin/vehicle/maintenance/get-employee" required>
                                                    </select>
                    </div>
                    ...
                    <div class="col-md-2">
                        ...
                        <select name="maintenance_type_id" id="maintenance_type_id" class="form-control"
                            data-ajax-url="admin/vehicle/maintenance/get-maintenance-type" required>
                                                    </select>
                    </div>
                    <div class="col-md-2">
