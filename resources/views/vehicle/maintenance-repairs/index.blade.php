                                        ...
                                        <div class="text-end">
                                            <div class="actions">
                                                <div class="accordion-header d-flex justify-content-end align-items-center" id="flush-headingOne">
                                                    <a class="btn btn-success btn-sm" href="javascript:void(0);" onclick="axiosModal('{{ route('maintenance.repair.create') }}')">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        @if ($maintenanceRepair->repair_status == 'pending' || $maintenanceRepair->repair_status == 'approved')
                                                            <a href="javascript:void(0);" onclick="axiosModal('{{ route('maintenance.repair.edit', $maintenanceRepair->id) }}')" class="btn btn-info btn-sm" title="Edit">
                                                                <i class="fa-solid fa-edit"></i>
                                                            </a>
                                                        @endif
                                                        @if ($maintenanceRepair->repair_status == 'billed' || $maintenanceRepair->repair_status == 'rejected')
                                                            <a href="javascript:void(0);" onclick="axiosModal('{{ route('maintenance.repair.redo-repair', $maintenanceRepair->id) }}')" class="btn btn-secondary btn-sm" title="Redo Repair">
                                                                <i class="fa-solid fa-rotate-right"></i>
                                                            </a>
                                                        @endif
                                                        @if ($maintenanceRepair->repair_status == 'pending')
                                                            <a href="javascript:void(0);" onclick="axiosModal('{{ route('maintenance.repair.approve', $maintenanceRepair->id) }}')" class="btn btn-primary btn-sm" title="Approve">
                                                                <i class="fa-solid fa-thumbs-up"></i>
                                                            </a>
                                                            <a href="javascript:void(0);" onclick="axiosModal('{{ route('maintenance.repair.reject', $maintenanceRepair->id) }}')" class="btn btn-warning btn-sm" title="Reject">
                                                                <i class="fa-solid fa-ban"></i>
                                                            </a>
                                                        @endif
                                                        @if ($maintenanceRepair->repair_status == 'approved')
                                                            <a href="javascript:void(0);" onclick="axiosModal('{{ route('maintenance.repair.bill', $maintenanceRepair->id) }}')" class="btn btn-primary btn-sm" title="Bill">
                                                                <i class="fa-solid fa-money-bill"></i>
                                                            </a>
                                                        @endif
                                                        @if ($maintenanceRepair->repair_status == 'pending' || $maintenanceRepair->repair_status == 'approved')
                                                            <a href="javascript:void(0);" onclick="axiosModal('{{ route('maintenance.repair.delete', $maintenanceRepair->id) }}')" class="btn btn-danger btn-sm" title="Delete">
