<form action="{{ route('maintenance.repair.redo-repair', $maintenanceRepair->id) }}" method="POST" class="needs-validation modal-content" novalidate="novalidate" enctype="multipart/form-data">
    @csrf
    @method('PUT')
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-lg-6">
                ...
                <div class="form-group row my-2">
                    ...
                    <div class="col-sm-7">
                        <input type="date" id="repair_date" name="repair_date" class="form-control" value="{{ $maintenanceRepair->repair_date }}" />
                    </div>
                </div>
                ...
                <div class="form-group row my-2">
                    ...
                    <div class="col-sm-7">
                        <select id="creator_id" name="creator_id" class="form-control" readonly>
                            <option value="{{ $maintenanceRepair->creator->id }}" selected>{{ $maintenanceRepair->creator->name }}</option>
                        </select>                        
                    </div>
                </div>
