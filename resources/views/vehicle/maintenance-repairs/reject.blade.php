<form action="{{ route('maintenance.repair.reject', $maintenanceRepair->id) }}" method="POST" class="needs-validation modal-content" novalidate="novalidate" enctype="multipart/form-data">
    @csrf
    @method('PUT')
