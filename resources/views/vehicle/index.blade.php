                        ...
                        <div class="row">
                            <div class="col-md-12 col-lg-6">
                                ...
                                <div class="form-group row my-2">
                                    ...
                                    <div class="form-group row my-2">
                                        <label for="driver_id" class="col-sm-5 col-form-label">Select Vehicle
                                            Class</label>
                                        <div class="col-sm-7">
                                            <select class="form-control basic-single select2" name="vehicle_class"
                                                ...
                                                @foreach ($vehicleClasses as $class)
                                                    <option value="{{ $class->name }}">Class {{ $class->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                            ...
                                            <div class="form-group row my-2">
                                                ...
                                                <div class="form-group row my-2">
                                                    ...
                                                    <div class="col-sm-7">
                                                        <input name="seats" class="form-control" type="number"
                                                            placeholder="No of Seats" id="seats"
                                                ...
                                                <div class="form-group row my-2">
                                                    <label for="driver_id" class="col-sm-5 col-form-label">Select Vehicle
                                                        Org</label>
                                                    <div class="col-sm-7">
                                                        <select class="form-control basic-single select2"
                                                            name="organisation_id" id="organisation_id" tabindex="-1"
                                                            aria-hidden="true">
