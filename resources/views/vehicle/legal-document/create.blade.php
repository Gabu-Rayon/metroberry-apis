<form
    action="admin/vehicle/legal-document"
    ...
    <input type="hidden" name="_token" value="AQNLvAb467g0eZtkGATqrKcNNVohCNfvLiX4IjQc" autocomplete="off">        <div class="card-header my-3 p-2 border-bottom">
        <h4>Legal Documentation Details</h4>
    </div>
        ...
        <div class="row">
            <div class="col-md-12 col-lg-6">
                ...
                <div class="form-group row my-2">
                    <label for="document_type_id" class="col-sm-5 col-form-label">Document type </label>
                    <div class="col-sm-7">
                        <select class="form-control basic-single" name="document_type_id" id="document_type_id"
                            ...
                            <option value="">Please select one</option>
                                                            <option value="1"
                                    >
                                    Vehicle Fitness</option>
                                                            <option value="2"
                                    >
                                    Vehicle Insurance</option>
                                                            <option value="3"
                                    >
                                    Vehicle Tax Token</option>
                                                            <option value="4"
                                    >
                                    Vehicle Route Permit</option>
                                                            <option value="5"
                                    >
                                    Vehicle Ownership Transfer</option>
                                                            <option value="6"
                                    >
                                    Vehicle Road Worthiness</option>
                                                            <option value="7"
                                    >
                                    libretto</option>
                                                    </select>
                ...
                <div class="form-group row mb-1">
                    <label for="vehicle" class="col-sm-5 col-form-label">Vehicle <i class="text-danger">*</i>
                    </label>
                    <div class="col-sm-7">
                ...
                <div class="form-group row my-2">
                    <label for="issue_date" class="col-sm-5 col-form-label">Last issue date <i
                            class="text-danger">*</i> </label>
                    <div class="col-sm-7">
                        <input name="issue_date" required class="form-control " type="date"
                            placeholder="Last issue date" id="issue_date"
                            value="">
                    </div>
                </div>

                <div class="form-group row my-2">
                    <label for="expiry_date" class="col-sm-5 col-form-label">Expire date <i
                            class="text-danger">*</i> </label>
                    <div class="col-sm-7">
                        <input name="expiry_date" class="form-control " type="date" placeholder="Expire date"
                ...
                <div class="form-group row my-2">
                    <label for="charge_paid" class="col-sm-5 col-form-label">Charge paid <i
                            class="text-danger">*</i> </label>
                    <div class="col-sm-7">
                        <input name="charge_paid" class="form-control" type="number" step="any"
                            placeholder="Charge paid" id="charge_paid"
                            value="" required>
                    </div>
                </div>
                ...
                <div class="form-group row my-2">
                    ...
                    <div class="col-sm-7">
                        <input name="commission" required class="form-control" type="number" step="any"
                            placeholder="Commission" id="commission"
                            value="" required>
                    </div>
                </div>
