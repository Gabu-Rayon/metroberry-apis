                                ...
                                <div class="card mb-4">
                                    <div class="card-header">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                <h6 class="fs-17 fw-semi-bold mb-0">Insurance details</h6>
                                            </div>
                                            <div class="text-end">
                                                <div class="actions">
                                                            ...
                                                            <div class='row pb-3 my-filter-form'>
                                                                ...
                                                                <div class="col-sm-12 col-xl-4">
                                                                    <div class="form-group row mb-1">
                                                                        <label for="company"
                                                                            class="col-sm-5 col-form-label justify-content-start text-left">Company
                                                                        </label>
                                                                        <div class="col-sm-7">
                                                                ...
                                                                <div class="col-sm-12 col-xl-4">
                                                                    <div class="form-group row mb-1">
                                                                        <label for="policy_number"
                                                                            class="col-sm-5 col-form-label justify-content-start text-left">Policy
                                                                            number </label>
                                                                        <div class="col-sm-7">
