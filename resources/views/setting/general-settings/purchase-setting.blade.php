...
@section('title', 'Purchase Setting')
@section('content')
                                    ...
                                    <div class="col-md-12">
                                        <div class="card mb-4 p-5">
                                            <form action="admin/setting" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div>
                                                    <fieldset>
                                                        <legend>Purchase Code Prefix</legend>
                                                        <div class="d-flex justify-content-between">
                                                            <div class="panel-heading my-2">
                                                                <code
                                                                    class="badge badge-pill badge-info text-light setting_key">setting('purchase.code_prefix')</code>
                                                                <a href="javascript:void(0);"
                                                                    class="panel-action-btn clipboard"
                                                                    data-clipboard-text="setting('purchase.code_prefix')">
                                                        ...
                                                        <div class="panel-body mt-1 mb-3">
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <input id="purchase.code_prefix" class="form-control"
                                                                        type="text"
                                                                        placeholder="Setting Purchase Code Prefix"
                                                                        name="data[11]" id="data[11]" value="PCP-" />
                                                                    <div class="my-1">
