                                    ...
                                    <div class="col-md-12">
                                        <div class="card mb-4 p-5">
                                            <form action="admin/setting" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div>
                                                    <fieldset>
                                                        <legend>Parts Code Prefix</legend>
                                                        <div class="d-flex justify-content-between">
                                                            <div class="panel-heading my-2">
                                                                <code
                                                                    class="badge badge-pill badge-info text-light setting_key">setting('inventory.parts_code_prefix')</code>
                                                                <a href="javascript:void(0);"
                                                                    class="panel-action-btn clipboard"
                                                                    data-clipboard-text="setting('inventory.parts_code_prefix')">
                                                        ...
                                                        <div class="panel-body mt-1 mb-3">
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <input id="inventory.parts_code_prefix"
                                                                        class="form-control" type="text"
                                                                        placeholder="Setting Parts Code Prefix"
                                                                        name="data[10]" id="data[10]" value="IPCP-" />
                                                                    <div class="my-1">
