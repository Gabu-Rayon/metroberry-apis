                                ...
                                <div class="card mb-4">
                                    <div class="card-header">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                <h6 class="fs-17 fw-semi-bold mb-0">Create new user</h6>
                                            </div>
                                            <div class="text-end">
                                                <div class="actions">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <form enctype="multipart/form-data" action="admin/user" method="POST"
                                                    class="needs-validation" enctype="multipart/form-data">
                                                    <input type="hidden" name="_token"
                                                        value="h5yfZkFK7ahUjn6ExY8n7lnGix2WZ6EzPGB3kZwC"
                                                        autocomplete="off">
                                                        ...
                                                        <div class=" row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group pt-1 pb-1">
                                                                    ...
                                                                    <input type="number"
                                                                        class="form-control arrow-hidden" name="phone"
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group pt-1 pb-1">
                                                                    <label for="age" class="font-black">Age</label>
                                                                    <input type="number"
                                                                        class="form-control arrow-hidden" name="age"
                                                            ...
                                                            <div class="col-md-6 py-1">
                                                                <div class="form-group pt-1 pb-1">
                                                                    <label for="address"
                                                                        class="font-black">Address</label>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6 pt-1 pb-1">
                                                                <div class="form-group">
                                                                    <label for="role" class="font-black">User
                                                                        role</label>
                                                                    <select class="form-control show-tick" name="role"
                                                                        id="role" required>
                                                                        <option selected disabled>--Select user role--
                                                                        </option>
                                                                        <option value="1">
                                                                            Administrator
                                                                        </option>
                                                            ...
                                                            <div class="col-md-6 pt-1 pb-1">
                                                                <div class="form-group">
                                                                    <label for="status" class="font-black">Account
                                                                        status</label>
                                                                    <select class="form-control show-tick" name="status"
                                                                        id="status" required>
                                                                        <option selected disabled>--Select account status--
                                                                        </option>
                                                                        <option>
                                                                            Pending
                                                                        </option>
                                                            ...
                                                            <div class="col-md-6 pt-1 pb-1">
                                                                <div class="form-group">
                                                                    <label for="password"
                                                                        class="font-black">Password</label>
                                                            ...
                                                            <div class="col-md-6 pt-1 pb-1">
                                                                <div class="form-group">
                                                                    <label for="password_confirmation"
                                                                        class="font-black">Confirm password</label>
                                                                    <input type="password" class="form-control"
                                                            ...
                                                            <div class="col-md-12 pt-1 pb-1">
                                                                <div>
                                                                    <h4
                                                                        class="border-bottom  py-1 mx-1 mb-0 font-medium-2 font-black">
