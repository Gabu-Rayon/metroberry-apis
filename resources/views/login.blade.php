...
<html lang="en">
  <head>
    <meta
      name="csrf-token"
      content="N7IOTTFtITsRuDJjQFNQrIQJUOuoDcNi4Tlfh2uD"
    />
    ...
    <link href="{{ asset('admin-assets/vendor/bootstrap/css/bootstrap.min.css?v=1')}}"
    rel="stylesheet" /
    <link
      href="{{ asset('admin-assets/vendor/metisMenu/metisMenu.min.css?v=1') }}"
      rel="stylesheet"
    />
    <link
      href="{{ asset('nanopkg-assets/vendor/datatables/dataTables.bootstrap4.min.css?v=1') }}"
      rel="stylesheet"
    />
    <link
      href="{{ asset('admin-assets/vendor/typicons/src/typicons.min.css?v=1') }}"
      rel="stylesheet"
    />
    <link
      href="{{ asset('admin-assets/vendor/themify-icons/themify-icons.min.css?v=1') }}"
      rel="stylesheet"
    />
    <link
      href="{{ asset('admin-assets/vendor/material_icons/materia_icons.css?v=1') }}"
      rel="stylesheet"
    />
    <link
      href="{{ asset('admin-assets/vendor/emojionearea/dist/emojionearea.min.css?v=1') }}"
      rel="stylesheet"
    />
    <link
      rel="stylesheet"
      href=" {{ asset('nanopkg-assets/vendor/highlight/highlight.min.css?v=1') }}"
    />
    <link
      href="{{ asset('nanopkg-assets/vendor/sweetalert2/sweetalert2.min.css?v=1') }}"
      rel="stylesheet"
    />
    <link
      href="{{ asset('nanopkg-assets/vendor/fontawesome-free-6.3.0-web/css/all.min.css?v=1') }}"
      rel="stylesheet"
    />
    <link
      href="{{ asset('nanopkg-assets/vendor/bootstrap-icons/css/bootstrap-icons.min.css?v=1') }}"
      rel="stylesheet"
    />
    <link
      href="{{ asset('nanopkg-assets/vendor/toastr/build/toastr.min.css?v=1') }}"
      rel="stylesheet"
    />
    ...
    <link rel="stylesheet" href="{{ asset('module-assets/Auth/css/login.min.css?v=1') }}" />
  </head>
  ...
  <body class="">
    ...
    <div class="container-fluid">
      <div class="row h-100vh align-aitems-center px-0">
            ...
            <div>
              ...
              <form class="register-form mt-3" method="POST" action="login">
                <input
                  type="hidden"
                  name="_token"
                  value="N7IOTTFtITsRuDJjQFNQrIQJUOuoDcNi4Tlfh2uD"
                  autocomplete="off"
                />
                <div class="mb-3">
                  <input
                    type="email"
                    class="form-control input-py"
                    id="email"
                    name="email"
                ...
                <button type="submit" class="btn signin-btn w-100">
                  Sign in
                </button>
              </form>
        ...
        <div
          class="col-lg-6 login-bg d-none d-lg-block overflow-hidden text-end py-2"
          style="background-image: url({{asset('admin-assets/img/login-bg.png?v=1')}})"
        >
          <img
            class="brand_logo"
            src=" {{asset('storage/setting/wMMoqiSiD6aqkO4CeiA4LzylK4Gbq4QAoP5OttpM.png?v=1')}}"
            alt=""
          />
        </div>
      </div>
    ...
    <script src="{{ asset('cnanopkg-assets/vendor/typed.js/lib/typed.min.js?v=1') }}"></script>
    <script src=" {{ asset('nanopkg-assets/vendor/jquery-validation-1.19.5/jquery.validate.min.js?v=1') }}"></script>
    <script src="{{ asset('cnanopkg-assets/js/axios.init.min.js?v=1') }}"></script>
    ...
    <script src="{{ asset('dmin-assets/js/custom.min.js?v=1') }}"></script>
    <script src="{{ asset('module-assets/Auth/js/login.min.js?v=1') }}"></script>
    <!-- end scripts -->
